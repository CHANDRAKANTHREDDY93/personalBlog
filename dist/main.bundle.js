...
module.exports = "<div class=\"col-md-12\">\r\n    <div class=\"col-md-4\" *ngFor=\"let item of getVideos | paginate: { itemsPerPage: 6, currentPage : p}\">\r\n        <iframe [src]=\"getEmbedURL(item.video)\" width=\"260\" height=\"150\" frameborder=\"0\" allowfullscreen>\r\n          </iframe>\r\n          <p>{{item.title}}</p>\r\n    </div>\r\n    <div class=\"col-md-2\"></div>\r\n  </div>\r\n  <pagination-controls (pageChange)=\"p=$event\"></pagination-controls>"
        ...
        this.subscriptionService.getSubscriptionList().subscribe(function (info) {
            ...
            _this.subscribeList.items.map(function (ele) {
                ...
                _this.subscriptionService.getPlayList(ele.snippet.resourceId.channelId).subscribe(function (data) {
                    ...
                    console.log(_this.playListItems);
                    _this.playListItems.items.map(function (item) {
                        ...
                        _this.subscriptionService.getSubscriptionVideoList(item.id).subscribe(function (list) {
                            ...
                            _this.getVideoList.items.map(function (q) {
                                ...
                                _this.getVideos.push({ video: url + q.snippet.resourceId.videoId, title: q.snippet.title });
                            });
                        });
                    });
                });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__time_of_india_time_of_india_component__ = __webpack_require__("./src/app/time-of-india/time-of-india.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__espn_espn_component__ = __webpack_require__("./src/app/espn/espn.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__newyork_times_newyork_times_component__ = __webpack_require__("./src/app/newyork-times/newyork-times.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_23__time_of_india_time_of_india_component__["a" /* TimeOfIndiaComponent */],
                __WEBPACK_IMPORTED_MODULE_24__espn_espn_component__["a" /* EspnComponent */],
                __WEBPACK_IMPORTED_MODULE_25__newyork_times_newyork_times_component__["a" /* NewyorkTimesComponent */]
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__time_of_india_time_of_india_component__ = __webpack_require__("./src/app/time-of-india/time-of-india.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__espn_espn_component__ = __webpack_require__("./src/app/espn/espn.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__newyork_times_newyork_times_component__ = __webpack_require__("./src/app/newyork-times/newyork-times.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'cnn', component: __WEBPACK_IMPORTED_MODULE_10__watch_later_watch_later_component__["a" /* WatchLaterComponent */] },
    { path: 'notifications', component: __WEBPACK_IMPORTED_MODULE_12__notifications_notifications_component__["a" /* NotificationsComponent */] },
    { path: 'upgrade', component: __WEBPACK_IMPORTED_MODULE_13__upgrade_upgrade_component__["a" /* UpgradeComponent */] },
    { path: 'search', component: __WEBPACK_IMPORTED_MODULE_17__components_search_search_component__["a" /* SearchComponent */] },
    { path: 'timesOfIndia', component: __WEBPACK_IMPORTED_MODULE_18__time_of_india_time_of_india_component__["a" /* TimeOfIndiaComponent */] },
    { path: 'espnCric', component: __WEBPACK_IMPORTED_MODULE_19__espn_espn_component__["a" /* EspnComponent */] },
    { path: 'newyorkTimes', component: __WEBPACK_IMPORTED_MODULE_20__newyork_times_newyork_times_component__["a" /* NewyorkTimesComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__search_search_component__ = __webpack_require__("./src/app/components/search/search.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__ = __webpack_require__("./node_modules/@angular/platform-browser/esm5/platform-browser.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__watch_later_youtube_service__ = __webpack_require__("./src/app/watch-later/youtube.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(compiler, element, appService, cookieService, sanitizer) {
        var _this = this;
    ...
    NavbarComponent.prototype.getEmbedURL = function (data) {
        return this.sanitizer.bypassSecurityTrustResourceUrl(data);
    };
    ...
    NavbarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["Compiler"], __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"], __WEBPACK_IMPORTED_MODULE_3__watch_later_youtube_service__["a" /* youTubeApiService */], __WEBPACK_IMPORTED_MODULE_1_angular2_cookie_services_cookies_service__["CookieService"], __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__["b" /* DomSanitizer */]])
    ], NavbarComponent);
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(sanitizer) {
        this.sanitizer = sanitizer;
        this.searchData = [];
        this.userData = [];
        this.searchItem = "Web Development";
    ...
    SearchComponent.prototype.getEmbedURL = function (data) {
        return this.sanitizer.bypassSecurityTrustResourceUrl(data);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], SearchComponent.prototype, "searchVideos", void 0);
...
/***/ "./src/app/espn/espn.component.scss":
/***/ (function(module, exports) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EspnComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__watch_later_youtube_service__ = __webpack_require__("./src/app/watch-later/youtube.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var EspnComponent = /** @class */ (function () {
    function EspnComponent(espnCricService) {
        var _this = this;
        this.espnCricService = espnCricService;
        this.getEspnCric = [];
        this.espnCricService.getEspnCric().subscribe(function (data) {
            _this.getEspnCric = data;
            console.log(_this.getEspnCric);
        });
    }
    ...
    EspnComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-espn',
            template: __webpack_require__("./src/app/espn/espn.component.html"),
            styles: [__webpack_require__("./src/app/espn/espn.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__watch_later_youtube_service__["a" /* youTubeApiService */]])
    ], EspnComponent);
...
module.exports = "<ol class=\"breadcrumb col-md-12\">\n    <li class=\"breadcrumb-item active\">Music</li>\n  </ol>\n<div class=\"col-md-12\">\n  <div class=\"col-md-4\" *ngFor=\"let item of getLatestMusicData | paginate: { itemsPerPage: 3, currentPage : p}\">\n      <iframe [src]=\"getEmbedURL(item.video)\" width=\"240\" height=\"150\" frameborder=\"0\" allowfullscreen>\n        </iframe>\n        <p>{{item.title}}</p>\n  </div>\n  <div class=\"col-md-2\"></div>\n</div>\n<pagination-controls (pageChange)=\"p=$event\"></pagination-controls>"
    ...
    function HomeComponent(latestDataApi, newsApi, sanitizer) {
        ...
        this.latestDataApi.getDefaultData().subscribe(function (data) {
            ...
            _this.getData.items.map(function (element) {
                ...
                _this.getLatestMusicData.push({ video: url + element.contentDetails.bulletin.resourceId.videoId, title: element.snippet.title });
            });
        });
...
/***/ "./src/app/newyork-times/newyork-times.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"col-md-4\" *ngFor=\"let data of getAllnewsData\">\n  <img src=\"{{data.image}}\" height=\"180px;\">\n  <p>{{data.title}}</p>\n</div>"

/***/ }),

/***/ "./src/app/newyork-times/newyork-times.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/newyork-times/newyork-times.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NewyorkTimesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__watch_later_youtube_service__ = __webpack_require__("./src/app/watch-later/youtube.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var NewyorkTimesComponent = /** @class */ (function () {
    function NewyorkTimesComponent(newyorkTimesService) {
        var _this = this;
        this.newyorkTimesService = newyorkTimesService;
        this.getNYTimes = [];
        this.getAllnewsData = [];
        this.newyorkTimesService.getNYTimes().subscribe(function (data) {
            _this.getNYTimes = data;
            _this.getNYTimes.articles.map(function (e) {
                _this.getAllnewsData.push({ title: e.title, image: e.urlToImage });
                console.log(_this.getAllnewsData);
            });
        });
    }
    NewyorkTimesComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-newyork-times',
            template: __webpack_require__("./src/app/newyork-times/newyork-times.component.html"),
            styles: [__webpack_require__("./src/app/newyork-times/newyork-times.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__watch_later_youtube_service__["a" /* youTubeApiService */]])
    ], NewyorkTimesComponent);
    return NewyorkTimesComponent;
}());
...
/***/ "./src/app/time-of-india/time-of-india.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"col-md-4\" *ngFor=\"let data of getNewsData\">\n    <img src=\"{{data.image}}\" height=\"180px;\">\n    <p>{{data.title}}</p>\n</div>"

/***/ }),

/***/ "./src/app/time-of-india/time-of-india.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/time-of-india/time-of-india.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TimeOfIndiaComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__watch_later_youtube_service__ = __webpack_require__("./src/app/watch-later/youtube.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var TimeOfIndiaComponent = /** @class */ (function () {
    function TimeOfIndiaComponent(toiService) {
        var _this = this;
        this.toiService = toiService;
        this.getToINews = [];
        this.getNewsData = [];
        this.toiService.getTOINews().subscribe(function (data) {
            _this.getToINews = data;
            console.log(_this.getToINews.articles);
            _this.getToINews.articles.map(function (e) {
                _this.getNewsData.push({ title: e.title, image: e.urlToImage });
                console.log(_this.getNewsData);
            });
        });
    ...
    TimeOfIndiaComponent.prototype.ngOnInit = function () {
    };
    TimeOfIndiaComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-time-of-india',
            template: __webpack_require__("./src/app/time-of-india/time-of-india.component.html"),
            styles: [__webpack_require__("./src/app/time-of-india/time-of-india.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__watch_later_youtube_service__["a" /* youTubeApiService */]])
    ], TimeOfIndiaComponent);
    return TimeOfIndiaComponent;
}());
...
module.exports = "<div class=\"col-md-12\">\n  <div class=\"col-md-4\" *ngFor=\"let data of getLatestTrendingData | paginate: { itemsPerPage: 3, currentPage : p}\">\n  <iframe [src]=\"getEmbedURL(data)\" width=\"260\" height=\"150\" frameborder=\"0\" allowfullscreen></iframe>\n  </div>\n  <!--<ngb-pagination [collectionSize]=\"30\" [(page)]=\"page\" aria-label=\"Default pagination\"></ngb-pagination>\n  -->\n</div>\n<pagination-controls (pageChange)=\"p=$event\"></pagination-controls>"
...
var TrendingComponent = /** @class */ (function () {
    function TrendingComponent(trendingAppService, sanitizer) {
        ...
        this.trendingAppService.getTrendingVideos().subscribe(function (items) {
            ...
            console.log(_this.trendingNowData);
...
module.exports = "<div class=\"col-md-12\">\n    <div class=\"col-md-4\" *ngFor=\"let news of setNewsData\">\n      <img src=\"{{news.image}}\" height= \"180px\"> \n        <p>{{news.title}}</p>\n    </div>\n</div>\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youtube_service__ = __webpack_require__("./src/app/watch-later/youtube.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WatchLaterComponent = /** @class */ (function () {
    function WatchLaterComponent(cnnNewsService) {
        var _this = this;
        this.cnnNewsService = cnnNewsService;
        this.getCNNnews = [];
        this.setNewsData = [];
        this.cnnNewsService.getCNNNews().subscribe(function (data) {
            _this.getCNNnews = data;
            _this.getCNNnews.articles.map(function (e) {
                _this.setNewsData.push({ title: e.title, image: e.urlToImage });
            });
        });
    }
    WatchLaterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__youtube_service__["a" /* youTubeApiService */]])
    ], WatchLaterComponent);
